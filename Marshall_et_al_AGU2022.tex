...
% \vspace{0.5cm}
\author{ \LARGE{Hans-Peter Marshall$^{1*}$, Zach Keskinen$^{1}$, Jeffrey Johnson$^{1}$, Scott Havens$^{2}$, Jack Tarricone$^3$, Eli Deeb$^4$, Jewell Lund$^5,6$, Rick Forster$^6$}\\ % \vspace{0.2cm}
...
\caption{UAVSAR PolSAR image over LCC (red=HH,green=HV,blue=VV) for Feb 23, 2021, after a large avalanche cycle.  Impact of avalanche debris can be seen as dark areas in runout zones.}
\end{figure}
\end{minipage}
